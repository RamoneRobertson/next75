...
-- Creating task_list for users

-- LIST 1
INSERT INTO task_list (id, user_id, start_date)
SELECT '123e4567-e89b-12d3-a456-426614174101',
       '123e4567-e89b-12d3-a456-426614174001',
       current_date

WHERE NOT EXISTS(SELECT 1 FROM task_list WHERE id = '123e4567-e89b-12d3-a456-426614174101');
...
WHERE NOT EXISTS(SELECT 1 FROM task_list WHERE id = '123e4567-e89b-12d3-a456-426614174102');
...
WHERE NOT EXISTS(SELECT 1 FROM task_list WHERE id = '123e4567-e89b-12d3-a456-426614174103');
...
WHERE NOT EXISTS(SELECT 1 FROM task_list WHERE id = '123e4567-e89b-12d3-a456-426614174104');
...
WHERE NOT EXISTS(SELECT 1 FROM task_list WHERE id = '123e4567-e89b-12d3-a456-426614174105');

-- Creating tasks for task_list
